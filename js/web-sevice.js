                ...
                if (data.consulta.length > 0) {
                    ...
                    $(data.consulta).each(function (n) {
                        ...
                        if (data.consulta[n].tipo_pub == 'Indexada') {
                            ...
                            $('#table-pub-indexadas').append(`
                            <tr ${style_index}>
                                <td style="width: 80%;padding-left: 20px;">
                                <span class="t-publicacion" id="publicacion_${data.consulta[n].id}">
                                ${data.consulta[n].titulo}
                                </span>
                                <span class="pub_datos">
                                    ${nombre_tipo_pub}
                                </span>
                                <br/>
                                <span class="t-autor pub_titulo"></span>
                                </td>
                                <td class="text-center">
                                    <a title="Enlace a la publicaci&oacute;n" 
                                        href="${doi}" 
                                        style="padding:5px;">
